...
import { CreateEntryInput, CreateSummaryInput, UpdateSettingsInput, EntryFilters } from '../sqlite/types';
...
export function registerDatabaseHandlers(): void {
  ...
  ipcMain.handle('db:getEntriesForDateRange', async (_event, startDate: string, endDate: string) => {
    try {
